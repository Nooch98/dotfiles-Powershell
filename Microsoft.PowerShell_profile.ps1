...
$(Clear-Host)
$(python 'C:\Users\Nooch\Desktop\Python\.\StatusConexion.py')
...
function youtube ($command) {
	youtube-dl.exe
}


function cnvim ($command) {
	cd C:\Users\Nooch\AppData\Local\nvim
}
...
function work ($command) {
	cd C:\Users\Nooch\Desktop\Python
}

function psc ($command) {
	cd C:\Users\Nooch\Documents\PowerShell
}

function pscs ($command) {
	cd C:\Users\Nooch\Documents\PowerShell\Scripts
}
...
function wfast ($command) {
	python C:\Users\Nooch\Desktop\Python\.\whatsappfast.py
}
...
Set-Alias rar 'C:\Program Files\WinRAR\Rar.exe'
